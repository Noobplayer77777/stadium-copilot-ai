      ...
      <div className="bg-black text-white antialiased min-h-screen">
        ...
        <aside className="fixed inset-y-0 left-0 z-[60] flex-col bg-black/95 border-r border-white/10 h-full w-80 hidden md:flex shadow-2xl">
          ...
          <nav className="flex-1 px-4 space-y-2 mt-4 overflow-y-auto">
            <Link href="/organizer/dashboard"><a className={`flex items-center gap-4 px-4 py-3 text-[#00f5ff] font-bold bg-white/5 border-l-4 border-[#00f5ff] transition-all duration-300 ease-in-out cursor-pointer ${pathname === '/organizer/dashboard' ? 'bg-white/10' : ''}`}><span className="material-symbols-outlined">memory</span><span className="font-sans text-sm">System Health</span></a></Link>

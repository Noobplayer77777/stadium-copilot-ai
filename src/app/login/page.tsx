...
export default function LoginPage() {
  ...
  const handleSignIn = (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // Simulate frontend-only login process
    setTimeout(() => {
      setIsLoading(false);
      ...
      >
        ...
        <Card className="border-[rgb(var(--border))] shadow-xl">
          ...
          <CardContent className="space-y-4">
            <Alert variant="default" className="bg-[rgb(var(--primary))]/5 border-[rgb(var(--primary))]/20 text-[rgb(var(--primary))]">
              <AlertDescription className="text-xs font-medium text-center">
                Authentication will be connected during backend implementation. Clicking Sign In routes to the demo Role Selector.
              </AlertDescription>
            </Alert>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#" className="text-xs font-medium text-[rgb(var(--primary))] hover:underline" tabIndex={-1}>
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="remember" className="text-sm font-normal text-[rgb(var(--muted-foreground))] leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
            ...
            <Button variant="outline" type="button" className="w-full" onClick={handleSignIn}>
                <svg className="mr-2 h-4 w-4 text-[#00a4ef]" viewBox="0 0 23 23" fill="currentColor">
